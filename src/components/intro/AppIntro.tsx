...
export function AppIntro({ onComplete, onOutStart }: AppIntroProps) {
    ...
    >
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            ...
            transitionTimingFunction:
              "cubic-bezier(0.22,1,0.36,1),cubic-bezier(0.2,0.75,0.2,1),cubic-bezier(0.2,0.75,0.2,1),cubic-bezier(0.2,0.75,0.2,1),linear,cubic-bezier(0.2,0.75,0.2,1)",
        ...
        >
          ...
          <div
            className={`absolute inset-0 grid transition-opacity duration-250 ${showStripLayer ? "opacity-100" : "opacity-0"}`}
          ...
          >
            {strips.map((stripIndex) => {
              ...
              const stripDelay =
                hasStripInTransition || hasStripOutTransition ? `${getRowDelayMs(stripIndex)}ms` : "0ms";
                ...
                <div key={stripIndex} className="relative overflow-hidden">
                  <div
                    ...
                    style={{
                      ...
                      transitionDuration: hasStripInTransition
                        ? `${STRIP_IN_MS}ms`
                        : hasStripOutTransition
                          ? `${STRIP_OUT_MS}ms`
                          : "0ms",
                      transitionTimingFunction:
                        hasStripInTransition || hasStripOutTransition ? "cubic-bezier(0.65,0,0.35,1)" : "linear",
